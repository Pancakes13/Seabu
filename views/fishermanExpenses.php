              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <strong class="card-title">Fisherman Expenses</strong>
...
function PopulateExpenseTable() {
    $.ajax({
      method: "POST",
      url: "../queries/get/getFishermanExpenses.php",
      ...
      var result = jsonObject.map(function (item) {
        ...
        result.push('<button type="button" class="btn btn-warning btn-sm editBtn" data-toggle="modal" data-target="#editModal" data-fisherman_expense_id="'+item.fisherman_expense_id+'" data-expense_name="'+item.item_name+'" data-price="'+item.price+'" data-qty="'+item.item_qty+'"><i class="fa fa-edit"></i></button>'
          +'<button type="button" class="btn btn-danger btn-sm delBtn" data-fisherman_expense_id="'+item.fisherman_expense_id+'" data-expense_name="'+item.item_name+'" ><i class="fa fa-trash"></i></button>');
        return result;
      });
...
$("#addBtn").on('click', function(){ 
            ...
            $.ajax({ 
              ...
              method: "POST",
              url: "../queries/insert/addFishermanExpense.php",

              data: {"name": name, "price": price, "qty": qty, "type": 'Ingredient'},
        ...
        $(document).on('click', '#itemTable .delBtn', function(){ 
          ...
          swalWithBootstrapButtons({
            ...
            if (result.value) {
            var id  = $(this).data("fisherman_expense_id");
            $.ajax({ 

              method: "POST",
              url: "../queries/delete/deleteFishermanExpense.php",

              data: {"fisherman_expense_id": id},
        ...
        $(document).on('click', '#submitEdit', function(){
          ...
          $.ajax({ 
            method: "POST",
            url: "../queries/update/updateFishermanExpense.php",
